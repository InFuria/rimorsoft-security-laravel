...
Route::middleware(['auth'])->group(function () {
    //Primero se aplica el middleware 'auth' para validar si el usuario esta loggeado
    //Route::post('ruta')->name('nombre de la ruta')->middleware('indice de middleware:permiso');
